...
class Home(tk.Frame):
    def __init__(self, parent, controller):
        ...
        home = tk.Button(self, text="HOME",font=("Arial",16,"bold"),bd=0, width = 10, bg="Pink", fg="black", command=lambda: controller.show(Home))
        home.place(x=380,y=300)
        home.config(cursor= "hand2")
        
        course = tk.Button(self, text="COURSES",font=("Arial",16,"bold"),bd=0, width = 10, bg="Pink", fg="black", command=lambda: controller.show(Courses))
        course.place(x=568,y=300)
        course.config(cursor= "hand2")
        
        students = tk.Button(self, text="REGISTRATION",font=("Arial",16,"bold"),bd=0, width = 13, bg="Pink", fg="black", command=lambda: controller.show(Students))
        students.place(x=750,y=300)
        students.config(cursor= "hand2")

        students = tk.Button(self, text="EXIT",font=("Arial",15,"bold"),bd=0, width = 10, bg="Pink", fg="black", command=iExit)
...
class Courses(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="COURSES", font=("Arial", 40))
        ...
        def tablec():
            conn = sqlite3.connect("SSI v2.db")
            cur = conn.cursor()
        ...
        home = tk.Button(self, text="HOME",font=("Arial",13,"bold"),bd=0, width = 10, bg="Pink", fg="black", command=lambda: controller.show(Home))
        home.place(x=1,y=35)
        home.config(cursor= "hand2")
        ...
        self.adds = Button(self, text="ADD", font=('Arial', 11, ), height=1, width=10, bd=1, bg="Pink", fg="black",command=add_course)
        self.adds.place(x=460,y=300)
        self.adds.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=('Arial', 11), height=1, width=10, bd=1, bg="Pink", fg="black", command=update_course) 
        self.update.place(x=460,y=360)
        self.update.config(cursor= "hand2")

        self.clear = Button(self, text="CLEAR", font=('Arial', 11), height=1, width=10, bd=1, bg="Pink", fg="black", command=clear)
        self.clear.place(x=460,y=420)
        self.clear.config(cursor= "hand2")

        self.delete = Button(self, text="DELETE", font=('Arial', 11), height=1, width=10, bd=1, bg="Pink", fg="black", command=delete_course)
        self.delete.place(x=460,y=480)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Arial', 11, 'bold'),bd=0, bg= "Pink", fg="black", command=search_course)
        self.search.place(x=1160,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Arial', 11, 'bold'), height=1, width=11, bg="Pink", fg="black", command=display_course)
...
class Students(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        home = tk.Button(self, text="HOME",font=("Arial",12,"bold"),bd=0, width = 7, bg="Pink", fg="black",  command=lambda: controller.show(Home))
        home.place(x=1,y=35)
        home.config(cursor= "hand2")
        ...
        self.add = Button(self, text="REGISTER", font=('Arial', 11), height=1, width=10, bd=1,  bg="Pink", fg="black", command=add_stud)
        self.add.place(x=150,y=420)
        self.add.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=('Arial', 11), height=1, width=10, bd=1, bg="Pink", fg="black", command=update_stud)
        ...
        self.delete = Button(self, text="DELETE", font=('Arial', 11), height=1, width=10, bd=1, bg="Pink", fg="black", command=delete_stud)
        self.delete.place(x=450,y=420)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Arial', 11, 'bold'),bd=0, bg= "Pink", fg="black", command=search_stud)
        self.search.place(x=1160,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Arial', 11, 'bold'), height=1, width=11,  bg="Pink", fg="black",command = display_stud)
        self.display.place(x=575,y=105)
        self.display.config(cursor= "hand2")
